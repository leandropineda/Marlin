...
#define STRING_CONFIG_H_AUTHOR "(lean, default config)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  18.41,  18.41 }
    #define DEFAULT_Ki_LIST {   1.69,   1.69 }
    #define DEFAULT_Kd_LIST {  50.16,  50.16 }
  #else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 164.90
  #define DEFAULT_bedKi 30.97
  #define DEFAULT_bedKd 585.38
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 137.2, 137.2 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, -10, -3.5 }
